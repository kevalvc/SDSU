...
from dataNormalization import rescaleMatrix, meanNormalization
from normData import minMaxNorm, meanNorm
...
sat = download_data('E:/Data/SDSU/Sem 1/ML/Assignments/HA 2/ha2/ha2/sat.csv', [1, 2, 4]).values # three columns: MATH SAT, VERB SAT, UNI. GPA  # convert frame to matrix
...
# INPUT THE ENTIRE MATRIX AS A PARAMETER FOR EITHER THE MIN MAX NORMALIZATION OR MEAN NORMALIZATION TECHNIQUES
sat = minMaxNorm(sat)
# sat = meanNorm(sat)
print(sat)
...
#% step-2: train a linear regression model using the Gradient Descent (GD) methodB
